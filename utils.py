...
def match_user_properties_to_existing_group_members(
    ...
    llm_result = _generic_profile_field_query(
        llm_plugin,
        field_type,
        field_type_verbose,
        field_value,
...
def match_user_properties_to_entitlement_properties(
    llm_plugin,
...
def compute_scores(access_request, llm_plugin):
    ...
    supervisoryorg_results = match_user_properties_to_existing_group_members(
        llm_plugin,
    ...
    entitlement_properties_results = match_user_properties_to_entitlement_properties(
        llm_plugin,
        access_request.requester.title_and_department,
    ...
    for title_result in title_results:
        percentage = _shared_words_percentage(
